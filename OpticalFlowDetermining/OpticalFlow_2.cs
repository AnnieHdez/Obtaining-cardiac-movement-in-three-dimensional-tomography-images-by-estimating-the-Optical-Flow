...
namespace OpticalFlowDetermining
{
    ...
    public class CensusOpticalFlowProcess3D : IOpticalFlowProcess3D
    {
        ...
        //public float3[] GetSuccesors(float3 pos)
        //{
        //    float2[] dir1 = { new float2(0, 1), new float2(0, -1), new float2(1, 0), new float2(-1, 0),
        //     new float2(-1, -1 ), new float2(1, 1 ),  new float2( 1, -1),  new float2( -1, 1)};

        //    float2[] dir2 = { new float2(0, 2), new float2(0, -2), new float2(1, 2),
        //     new float2( 1, -2 ), new float2( -1, 2 ),  new float2( -1, -2),  new float2( 2, 0 ),
        //    new float2(-2, 0), new float2(2, 1), new float2(-2, 1), new float2( 2, -1 ), new float2( -2, -1 ),  
        //    new float2( 2, 2 ), new float2( 2, -2 ), new float2( -2, 2 ), new float2( -2, -2 )};

        //    float2[] dir3 = { new float2(0, 3), new float2(0, -3), new float2(1, 3),
        //     new float2( 1, -3 ), new float2( -1, 3 ),  new float2( -1, -3),  new float2( 3, 0 ),
        //    new float2(-3, 0), new float2(3, 1), new float2(-3, 1), new float2( 3, -1 ), new float2( -3, -1 ),
        //    new float2( 3, 3 ), new float2( 3, -3 ), new float2( -3, 3 ), new float2( -3, -3 ),
        //     new float2(-3, 2), new float2(3, 2), new float2(-3, -2), new float2( 3, -2 ),
        //     new float2(2,-3), new float2(2, 3), new float2(-2, -3), new float2( -2, 3)};

        //    //float2[] dir4 = { new float2(0, 4), new float2(0, -4), new float2(1, 4),
        //    // new float2( 1, -4 ), new float2( -1, 4 ),  new float2( -1, -4),  new float2( 4, 0 ),
        //    //new float2(-4, 0), new float2(4, 1), new float2(-4, 1), new float2( 4, -1 ), new float2( -4, -1),
        //    //new float2( 4, 4 ), new float2( 4, -4 ), new float2( -4, 4 ), new float2( -4, -4 ),
        //    // new float2(-4, 2), new float2(4, 2), new float2(-4, -2), new float2( 4, -2 ),
        //    // new float2(2,-4), new float2(2, 4), new float2(-2, -4), new float2( -2, 4),
        //    // new float2(-4, 3), new float2(4, 3), new float2(-4, -3), new float2( 4, -3 ),
        //    // new float2(3,-4), new float2(3, 4), new float2(-3, -4), new float2( -3, 4)};

        //    float3[] result = new float3[342];

        //    int count = 0;

        //    int[] zs = { 0, -1, 1, -2, 2, -3, 3, -4, 4 };

        //    #region Vecindad 1
        //    for (int j = 0; j < 3; j++)
        //        for (int i = 0; i < 8; i++)
        //        {
        //            result[count] = new float3(dir1[i].x + pos.x, dir1[i].y + pos.y, pos.z + zs[j]);
        //            count++;
        //        }
             
        //    result[24] = new float3(pos.x, pos.y, pos.z + 1);
        //    result[25] = new float3(pos.x, pos.y, pos.z - 1);
        //    count += 2;
        //    #endregion
        ...
        //        for (int i = 0; i < 16; i++)
        //        {
        //            result[count] = new float3(dir2[i].x + pos.x, dir2[i].y + pos.y, pos.z + zs[j]);
        //            count++;
        //        }            
        ...
        //    result[count] = new float3(pos.x, pos.y, pos.z + 2);
        //    count++;
        //    result[count] = new float3(pos.x, pos.y, pos.z - 2);
        //    count++;
        //    #endregion
        ...
        //        for (int i = 0; i < 24; i++)
        //        {
        //            result[count] = new float3(dir3[i].x + pos.x, dir3[i].y + pos.y, pos.z + zs[j]);
        //            count++;
        //        }
        ...
        //    result[count] = new float3(pos.x, pos.y, pos.z + 3);
        //    count++;
        //    result[count] = new float3(pos.x, pos.y, pos.z - 3);
        //    count++;
        //    #endregion
        ...
        //    //    for (int i = 0; i < 32; i++)
        //    //    {
        //    //        result[count] = new float3(dir4[i].x + pos.x, dir4[i].y + pos.y, pos.z + zs[j]);
        //    //        count++;
        //    //    }
        ...
        //    //result[count] = new float3(pos.x, pos.y, pos.z + 4);
        //    //count++;
        //    //result[count] = new float3(pos.x, pos.y, pos.z - 4);
        //    #endregion
